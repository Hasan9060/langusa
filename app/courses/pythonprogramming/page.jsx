            ...
            <div className="lg:col-span-2">
              ...
              <div className="mb-8">
                <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
                  5-Month Python Programming for Beginners Course Basic - Advanced
                </h1>
                    ...
                    <section>
                      ...
                      <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg transition-colors duration-300">
                        <p className="text-gray-700 dark:text-gray-300 mb-4">
                          Join this 5-month Python Programming for Beginners Course to learn from basic to advanced level.
                        </p>
                        <p className="text-gray-700 dark:text-gray-300 font-medium mb-2">
                          Course Highlights:
                        </p>
                        <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
                         <li>Live interactive classes for 5 months</li>
      <li>Practice exercises after every lesson</li>
      <li>Comprehensive topic-wise notes</li>
      <li>Hands-on Python projects for real-world practice</li>
                        </ul>
                      </div>
                    </section>
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center mb-4">
                    <div className="text-2xl font-bold text-blue-700 dark:text-blue-300 mr-2">
                      <span className="text-black dark:text-white">RS</span> 3000
                    </div>
                    <div className="text-lg text-red-500 line-through mr-2">RS 5000</div>
                     <div className="text-sm font-medium text-white  bg-cyan-600 px-2 py-1 rounded">
                      Montly
                    </div>
                  </div>
