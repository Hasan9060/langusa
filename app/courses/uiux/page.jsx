            ...
            <div className="lg:col-span-2">
              ...
              <div className="mb-8">
                <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
                  3-Month UI/UX Design Course to Master Design from Basics to Advanced
                </h1>
                    ...
                    <section>
                      ...
                      <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg transition-colors duration-300">
                        <p className="text-gray-700 dark:text-gray-300 mb-4">
                          Join this 3-month course to learn UI/UX design confidently from basic concepts to advanced techniques.
                        </p>
                        <p className="text-gray-700 dark:text-gray-300 font-medium mb-2">
                          Course Highlights:
                        </p>
                        <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
                           <li>Live interactive design classes for 3 months</li>
  <li>Hands-on design exercises and projects</li>
  <li>Comprehensive topic-wise notes and resources</li>
  <li>Portfolio-ready projects</li>
                    ...
                    <section>
                      <div className="flex flex-col md:flex-row gap-6">
                        <div className="flex items-start">
                          ...
                          <div>
                            <h3 className="font-bold text-gray-900 dark:text-white">3-Month Access</h3>
                            <p className="text-gray-600 dark:text-gray-300">
                              Full access to UI/UX course material for 3 months
                            </p>
                          </div>
                        </div>
                      </div>
                ...
                <section className="mb-8">
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          <h3 className="text-xl font-bold text-gray-900 dark:text-white">Syed Hasan Rafay</h3>
                          <p className="text-gray-600 font-medium">Vectonix</p>
                        </div>
                      </div>
                    </section>             
              ...
              <div className="top-24 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-md overflow-hidden transition-colors duration-300">
                ...
                <div className="p-4">
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">
                    UI/UX design basic concepts to advanced techniques.
                  </h3>
