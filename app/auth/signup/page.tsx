  ...
  return (
    <div className="pt-28 min-h-screen flex items-center justify-center transition-colors duration-300 p-4 dark:bg-gray-900">
      <div className="w-full max-w-4xl flex flex-col sm:flex-row rounded-3xl shadow-2xl overflow-hidden border backdrop-blur-lg bg-white/80 border-white/20 dark:bg-gray-900/60 dark:border-gray-700">
        ...
        {/* LEFT SIDE — Header */}
        <div className="sm:w-1/2 bg-gradient-to-r from-green-600 to-blue-500 relative flex flex-col justify-center items-center sm:items-start sm:pl-10 p-8 text-center sm:text-left">
          ...
          <img
            src="/Images/logo.png"
            alt="Logo"
            className="w-32 object-contain drop-shadow-lg sm:w-40 sm:items mb-2"
          />

          <h1 className="text-lg sm:text-3xl font-bold text-white drop-shadow-md">THE FUTURE OF EDUCATION IS HERE!</h1>
        </div>
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-amber-400 bg-white/70 dark:bg-gray-800/50 transition-all"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-amber-400 bg-white/70 dark:bg-gray-800/50 transition-all pr-10"
                />
                <button
                  type="button"
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-amber-600 to-orange-700 text-white py-3 rounded-xl font-semibold hover:from-amber-700 hover:to-orange-800 transform hover:scale-[1.02] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
